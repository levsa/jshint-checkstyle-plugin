...
public class CheckStyleParser extends AbstractAnnotationParser {
    ...
    public Collection<FileAnnotation> parse(final InputStream file, final String moduleName) throws InvocationTargetException {
        try {
            ...
            digester.addObjectCreate(fileXPath, hudson.plugins.jshint.parser.File.class);
            digester.addSetProperties(fileXPath);
            digester.addSetNext(fileXPath, "addFile", hudson.plugins.jshint.parser.File.class.getName());
    ...
    private Collection<FileAnnotation> convert(final CheckStyle collection, final String moduleName) {
        ...
        for (hudson.plugins.jshint.parser.File file : collection.getFiles()) {
     ...
     */
    private boolean isValidWarning(final hudson.plugins.jshint.parser.File file) {
